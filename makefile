...
OBJFILES_ASSEMBLER := assembler.o scan_labels.o command_argument_handler.o
...
DIROBJFILES := $(DIROBJFILES_MAIN) $(DIROBJFILES_ASSEMBLER)  $(DIROBJFILES_MY_STACK) $(DIROBJFILES_SPU)  $(DIROBJFILES_PROCESSOR)
